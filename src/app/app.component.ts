...
export class AppComponent {
  ...
  REST - Spring web Flow-Java 11- Spring Boot-Apache Tiles- Scrum Agile-Git(GitFlow)-Jenkins-Sonar-
  Openshift-JSP-Taglibs -Jira-Jacoco-Junit5-Spring Tools Suite-HTML-CSS-SQL:DB2.

  >Java Swing Developer( 01/2021- 30/11/2022)
  at Dedalus Group(DXC Technology).

  - Participated in version creation by developing requirements and resolving incidents
  ...
  Java - XML -  Apache POI - Spring Boot-MyBatis- Spring Data JPA-AngularJS
...
learningTraining=`Academic Background
